    ...
    <HelmetProvider>
      <ThemeProvider theme={theme}>
        ...
        >
          ...
          données personnelles, hors données d'authentification. Des cookies
          sont utilisés à des fins statistiques ou de fonctionnement, ainsi que
          d'analyse (que vous pouvez refuser ici), nous permettant d'améliorer
          le site en continu.
        </CookieConsent>
